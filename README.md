...
4. Run the application: `npm react-native start` or `yarn react-native start`
5. Open another terminal and run: `npm react-native run-android` or `yarn react-native run-android`
